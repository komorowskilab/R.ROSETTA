...
rosetta <- function(dt,
                    ...
                    JohnsonParam=c(Modulo=TRUE,BRT=FALSE,BRTprec=0.9,Precompute=TRUE,Approximate=TRUE,Fraction=0.85),
                    GeneticParam=c(Modulo=TRUE,BRT=FALSE,BRTprec=0.9,Precompute=TRUE,Approximate=TRUE,Fraction=0.85,Algorithm="Simple"),
                    ManualNames=c(),
                    pAdjust=TRUE,
                    pAdjustMethod="BH",
                    seed=1,
