...
```{r, echo = TRUE, fig.align='center', warning=FALSE, eval=FALSE}
dt <- synData(nFeatures=c(20,2,2,3,3), rf=c(0.2,0.2,0.3,0.5,0.5), rd=c(0.5,0.1,0.7,0.8,0.2), nObjects=100, nOutcome=2, 
out <- rosetta(dt)
out$main
```
```{r, echo = FALSE, warning=FALSE, message=FALSE, results='asis'}
...
```{r, echo = TRUE, fig.align='center', warning=FALSE, eval=FALSE}
dt <- synData(nFeatures=c(20,2,2,3,3), rf=c(0.1,0.1,0.7,0.7,0.7), rd=c(0.5,0.1,0.7,0.8,0.2), nObjects=100, nOutcome=2, 
out <- rosetta(dt)
out$quality
```
```{r, echo = FALSE, warning=FALSE, message=FALSE, results='asis'}
